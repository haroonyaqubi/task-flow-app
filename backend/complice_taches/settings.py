# backend/complice_taches/settings.py
import os
...
STATICFILES_DIRS = []  # Empty for now
...
# Create staticfiles folder if it doesn't exist (REMOVE THIS LINE IF PRESENT)
# os.makedirs(STATIC_ROOT, exist_ok=True)  # <-- DELETE OR COMMENT THIS LINE